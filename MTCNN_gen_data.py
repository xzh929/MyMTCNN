...
from MTCNN_method import iou

# anno_src = r"D:\MTCNN\celeba\Anno\list_bbox_celeba.txt"
anno_src = r"F:\imgdata\img.txt"
# img_dir = r"D:\MTCNN\celeba\img_celeba.7z\img_celeba"
img_dir = r"F:\imgdata"

save_path = r"F:\data"
validate_path = r"F:\data2"
...
def gen_sample(face_size, stop_value, ratio_arr=[1, 3, 1]):
    ...
    negative_count = 60000
    part_count = 20000

    try:
        positive_anno_file = open(positive_anno_filename, "a")
